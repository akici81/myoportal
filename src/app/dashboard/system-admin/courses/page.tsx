        ...
        <table className="w-full text-left text-sm text-muted">
          <thead className="card text-xs uppercase text-gray-500">
            <tr>
              ...
              <th className="px-5 py-4 text-center text-red-400">⏱ Haftalık</th>
            ...
            <form onSubmit={save} className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <div className="w-full bg-purple-900/20 border border-red-600/30 rounded-lg px-3 py-2.5 text-red-300 font-black text-center text-lg">
