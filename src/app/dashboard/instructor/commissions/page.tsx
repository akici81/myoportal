            ...
            <div key={member.id} className="relative rounded-2xl border border-white/5 bg-gray-800/30 p-6 transition-all hover:border-cyan-500/30">
              ...
              <div className="mt-6 border-t border-white/5 pt-4">
                {member.commission.drive_folder_url ? (
                   <a target="_blank" rel="noopener noreferrer" href={member.commission.drive_folder_url} className="inline-flex w-full items-center justify-center rounded-xl bg-gray-900/50 px-4 py-2 text-sm font-medium text-gray-300 transition-colors hover:bg-gray-800 hover:text-white border border-white/5">
                     <FileText className="mr-2 h-4 w-4" /> Ortak Klasör
                   </a>
                ) : (
                   <button disabled className="inline-flex w-full items-center justify-center rounded-xl bg-gray-900/20 px-4 py-2 text-sm font-medium text-gray-500 border border-white/5 cursor-not-allowed">
