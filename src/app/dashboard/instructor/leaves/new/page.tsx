...
export default function NewLeaveRequestPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 animate-in">
      ...
      <form onSubmit={handleSubmit} className="space-y-6 rounded-2xl border border-white/5 bg-gray-800/30 p-6 backdrop-blur-xl">
        {error && (
        ...
        <div className="flex justify-end pt-2 border-t border-white/5">
           <button
             type="submit"
             disabled={loading}
             className="inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-cyan-500 to-blue-500 px-6 py-2.5 text-sm font-medium text-white shadow-lg shadow-cyan-500/20 transition-all hover:from-cyan-400 hover:to-blue-400 disabled:opacity-50 disabled:cursor-not-allowed"
           >
