...
export default async function MYInstructorsPage() {
  ...
  return (
    <div className="space-y-6 animate-in">
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-amber-900/40 via-yellow-900/20 to-gray-900 p-8 border border-amber-800/30">
        ...
        <div className="relative z-10">
          ...
          <p className="mt-2 text-gray-400">Tüm MYO bünyesindeki öğretim elemanlarının görünümü</p>
        </div>
      </div>
