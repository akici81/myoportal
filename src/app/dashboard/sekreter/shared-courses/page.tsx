  ...
  return (
    <div className="space-y-8 animate-in pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Stat Cards */}
        <div className="glass-card p-6 rounded-2xl border border-gray-800 flex items-center gap-4 bg-gradient-to-br from-indigo-900/10 to-transparent">
        ...
        <div className="glass-card p-6 rounded-2xl border border-gray-800 flex items-center gap-4 bg-gradient-to-br from-blue-900/10 to-transparent">
        ...
        <div className="glass-card p-6 rounded-2xl border border-gray-800 flex items-center gap-4 bg-gradient-to-br from-amber-900/10 to-transparent">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-2/3 space-y-6">
          ...
          <div className="space-y-4">
            {loading ? (
              <div className="glass-card border border-gray-800 rounded-2xl p-12 flex flex-col items-center justify-center text-gray-500 animate-pulse">
              ...
              filteredGroups.map((group) => {
                ...
                return (
                  <div 
                    ...
                    className="glass-card rounded-2xl border border-gray-800 overflow-hidden transition-all duration-300 group hover:border-indigo-500/30"
                  >
                    <div 
        ...
        <div className="lg:w-1/3 space-y-6">
          <div className="glass-card p-6 rounded-2xl border border-indigo-500/20 bg-indigo-500/5 relative overflow-hidden group">
          ...
          <div className="glass-card p-5 rounded-2xl border border-gray-800 bg-gray-900/60">
      ...
      {showModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="glass-card w-full max-w-lg bg-gray-900 rounded-2xl border border-gray-700 shadow-2xl overflow-hidden relative z-10 animate-in zoom-in-95 duration-200 flex flex-col max-h-[90vh]">
            ...
            <div className="p-5 border-t border-gray-800 bg-gray-900/50 flex gap-3 shrink-0">
              ...
              <button
                ...
                className="flex-1 btn-glow py-3 px-4 rounded-xl text-sm font-bold text-white bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-500 hover:to-blue-500 transition-all shadow-lg shadow-indigo-500/20 disabled:opacity-50 disabled:shadow-none flex items-center justify-center gap-2"
              >
                {saving ? (
